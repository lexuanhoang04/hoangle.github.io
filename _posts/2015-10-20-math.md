...
This theme supports rendering beautiful math in inline and display modes using [MathJax 3](https://www.mathjax.org/) engine. You just need to surround your math expression with `$$`, like `$$ F = ma $$`. If you leave it inside a paragraph, it will produce an inline expression, just like $$ F = ma $$.
